      ...
      classes: [
        {
          ...
          courseDesc: 'Computer arithmetic, design of high-speed adders and multipliers, CPU concepts, instruction fetching and decoding, hardwired control, microprogramming control, main memory, I/O organization, assembly language programming techniques, CPU instruction sets and addressing modes.',
          hours: 3,
          substitutions: [],
        ...
        },
        {
          ...
          courseNumber: 0,
          courseName: 'Humanity',
          courseDesc: 'General education 3+ hour humanities course requirement.',
          hours: 3,
          substitutions: [],
          prereqs: [],
          coreqs: []
        },
        {
          courseDept: 'GenEd',
          courseNumber: 0,
          courseName: 'Science Sequence II',
          courseDesc: '3+ hour second class in a physical science sequence',
          hours: 3,
          substitutions: [],
          prereqs: [],
          coreqs: []
        },
        {
          courseDept: 'GenEd',
          courseNumber: 2259,
          courseName: 'Science Sequence Lab II',
          courseDesc: 'Lab to go along with Science Sequence II class.',
          hours: 3,
          substitutions: [],
          prereqs: [],
          coreqs: []
